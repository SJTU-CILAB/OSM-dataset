...
### Evaluation on Traffic Prediction Task
**If you want to evaluate the OSM+ dataset on traffic prediction task**: We provide a benchmark on 7 baseline methods based on OSM+ combined with UTD19 datasets. The following table shows the average performance when horizon = 3,6,12.
