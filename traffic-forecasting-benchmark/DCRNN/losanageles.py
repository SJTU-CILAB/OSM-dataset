...
data = np.load('/mnt/nas/home/cilab/Suziyang/NIPS2024/BasicTS/datasets/raw_data/losanageles/data.npz')['data']

# ================= general ================= #
CFG.DESCRIPTION = "DCRNN model configuration"
CFG.RUNNER = SimpleTimeSeriesForecastingRunner
CFG.DATASET_CLS = TimeSeriesForecastingDataset
CFG.DATASET_NAME = "losanageles"
