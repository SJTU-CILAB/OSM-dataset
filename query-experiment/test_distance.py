...
o = ODPS('eCWJKNSgOAwj0Vr7', 'Jp3eplgHYOwKndLh4E9x6322QpzywW', 'aster',
...
# insert into osm_roadnet_kde_mean_test2
...
def run_part_1_5(j):
    ...
    #time1 = time.time()
    #osm_roadnet_level_distance_opt
    sql= 'insert into   osm_density ' + \
                                ...
                                '    from (select * from osm_roadnet_level_distance_opt where idx % 6 = ## and   x %  48000 <= 24000 and y % 48000 <= 24000 ) center, osm_roadnet_level_distance_opt point ' + \
