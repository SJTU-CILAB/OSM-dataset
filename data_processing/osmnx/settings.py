...
# OSM node/way tags to add as graph node/edge attributes when these tags are present in the data retrieved from OSM
# useful_tags_node = ["aerialway", "aeroway", "amenity", "barrier", "boundary", "admin_level", "building",
# "entrance", "height", "craft", "emergency", "geological", "healthcare", "highway", "ford", "lit", "historic",
# "landuse", "leisure", "man_made", "military", "natural", "office", "place", "population", "is_in", "power",
# "public_transport", "railway", "shop", "sport", "telecom", "tourism", "water", "waterway", "name", "crossing",
# "noexit", "traffic_sign"]
useful_tags_node = ["name", "aerialway", "aeroway", "amenity", "barrier", "boundary",
                    "admin_level", "building", "entrance", "height", "craft", "emergency", "geological", "healthcare",
                    "highway", "ford", "lit", "historic", "landuse", "leisure", "man_made", "military", "natural",
                    "office", "place", "population", "is_in", "power", "public_transport", "railway", "shop", "sport",
                    "telecom", "tourism", "water", "waterway", "crossing"]

# useful_tags_way = ["aerialway", "aeroway", "amenity", "barrier", "boundary", "admin_level", "building", "entrance",
# "height", "craft", "emergency", "geological", "healthcare", "highway", "footway", "sidewalk", "cycleway",
# "abutters", "bicycle_road", "bus_bay", "embankment", "embedded_rails", "ford", "ice_road", "junction", "lanes",
# "lit", "motorroad", "oneway", "overtaking", "passing_places", "priority_road", "sac_scale", "service",
# "smoothness", "surface", "turn", "width", "winter_road", "historic", "landuse", "leisure", "man_made", "military",
# "natural", "office", "place", "population", "is_in", "power", "line", "public_transport", "railway", "tunnel",
# "tracks", "usage", "route", "shop", "sport", "telecom", "tourism", "water", "waterway", "name", "area", "bridge",
# "est_width", "access", "maxaxleload", "maxheight", "maxlength", "maxspeed", "maxstay", "maxweight", "maxwidth",
# "minspeed", "noexit"]
useful_tags_way = ["name", "aerialway", "aeroway", "amenity", "barrier", "boundary", "admin_level", "building",
                   "entrance", "craft", "emergency", "geological", "healthcare", "highway", "footway", "sidewalk",
                   ...
                   "public_transport", "railway", "usage", "route", "shop", "sport", "telecom",
                   "tourism", "water", "waterway", "area", "bridge", "access", "est_width", "maxwidth", "maxaxleload",
                   "maxheight", "maxlength", "maxstay", "maxweight", "maxspeed", "minspeed"]
